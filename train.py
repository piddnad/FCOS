...
train_dataset = VOCDataset(root_dir='/home/kxy/datasets/VOC2012',resize_size=[640,800], split='trainval',use_difficult=False,is_train=True,augment=transform, mean=config.mean,std=config.std)
